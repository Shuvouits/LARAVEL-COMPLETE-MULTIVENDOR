...
class ProductController extends Controller
{
    ...
    public function AddProduct(){
        ...
        return view('admin.product.add_product', compact('activeVendor', 'brands', 'categories'));
    }
    ...
    public function StoreProduct(Request $request){
        ...
        return redirect('/all-product')->with($notification); 
    ...
    public function EditProduct($id){
         ...
         return view('admin.product.edit_product',compact('brands','categories','activeVendor','products','subcategory','multiImgs'));
     }// End Method  
