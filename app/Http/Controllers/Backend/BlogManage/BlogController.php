...
class BlogController extends Controller
{
    public function AllBlogCateogry(){
        ...
        return view('admin.blog.blogcategory_all',compact('blogcategoryies'));
    ...
    public function StoreBlogCateogry(Request $request){
       ...
       $notification = array(
        ...
        return redirect('/admin/blog/category')->with($notification); 
    ...
    public function EditBlogCateogry($id){
        ...
        return view('admin.blog.blogcategory_edit',compact('blogcategoryies'));
    ...
    public function AllBlogPost(){
        ...
        return view('admin.blog.blogpost_all',compact('blogpost'));
    ...
    public function AddBlogPost(){
        ...
        return view('admin.blog.blogpost_add',compact('blogcategory'));
    } // End Method 
    ...
    public function StoreBlogPost(Request $request){
        ...
        Image::make($image)->resize(1103,906)->save('AdminBackend/upload/blog/'.$name_gen);
        $save_url = 'AdminBackend/upload/blog/'.$name_gen;
    ...
    public function EditBlogPost($id){
       ...
       return view('admin.blog.blogpost_edit',compact('blogcategory','blogpost'));
   }// End Method 
