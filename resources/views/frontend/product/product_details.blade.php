                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    @if ($product->discount_price == null)
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">TK.{{ $product->selling_price }}</span>

                                        </div>
                                    @else
                                        <div class="product-price primary-color float-left">
                                            <span class="current-price text-brand">TK.{{ $product->discount_price }}</span>
                                            <span>
                                                <span class="save-price font-md color3 ml-15">{{ round($discount) }}%
                                                    Off</span>
                                                <span
                                                    class="old-price font-md ml-15">TK.{{ $product->selling_price }}</span>
                                            </span>
                                        </div>
                                    @endif
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <div class="vendor-logo d-flex mb-30">
                                            <img src="{{ asset('AdminBackend/upload/vendor_image/' . $product->vendor->photo) }}"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="user justify-content-between d-flex">
                                                                        <div class="thumb text-center">
                                                                            <img src="{{ !empty($item->user->photo) ? url('AdminBackend/upload/user_image/' . $item->user->photo) : url('AdminBackend/upload/no_image.jpg') }}"
                                                                                alt=""
