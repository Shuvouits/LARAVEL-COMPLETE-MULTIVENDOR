                            ...
                            <article class="wow fadeIn animated hover-up mb-30 animated">
                                ...
                                <div class="entry-content-2 pl-50">
                                    <h3 class="post-title mb-20">
                                        <a href="/post/details/{{$post->id}}/{{$post->post_slug}}">{{ $post->post_title }}</a>
                                    </h3>
                                    ...
                                    <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                        <div>
                                         ...
                                         <a href="/post/details/{{$post->id}}/{{$post->post_slug}}" class="text-brand font-heading font-weight-bold">Read more <i class="fi-rs-arrow-right"></i></a>
                                    </div>
                                </div>
                            </article>
                        @endforeach
                        ...
                        <div class="sidebar-widget widget-category-2 mb-50">
                            ...
                            <ul>
                                @foreach ($blogcategoryies as $category)
                                    ...
                                    <li>
                                        <a href="/post/category/{{$category->id}}/{{$category->blog_category_slug}}"> <img
