            ...
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="myForm" method="post" action="/update/brand" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class=" form-group col-sm-9 text-secondary">
                                            <input type="text" name="brand_name" class="form-control" value="{{ $brand_data->brand_name }}" />
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($brand_data->brand_image) ? url($brand_data->brand_image) : url('AdminBackend/no_image.jpg') }}"
