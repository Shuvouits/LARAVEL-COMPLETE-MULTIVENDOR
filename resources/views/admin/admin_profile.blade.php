            ...
            <div class="main-body">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src=" {{ !empty($admin_data->photo) ? url('AdminBackend/upload/admin_image/'.$admin_data->photo) : url('AdminBackend/no_image.jpg') }}"
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data" action="/admin/profile/store">
                                    @csrf
