...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="/inactive/vendor/approve" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					...
					{{ $activeVendorDetails->vendor_info }}
				</textarea>
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($activeVendorDetails->photo)) ? url('AdminBackend/upload/vendor_image/'.$activeVendorDetails->photo):url('AdminBackend/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
