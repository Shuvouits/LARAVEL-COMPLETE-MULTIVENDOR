    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" method="post" action="/update/product">
                    @csrf
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="/update/product/thumbnail">
                    @csrf
                    <input type="hidden" name="id" value="{{ $products->id }}" />
                    <input type="hidden" name="old_img" value="{{ $products->product_thambnail }}" />
                    <div class="mb-3">

                        <input class="form-control" type="file" name="product_thambnail" id="formFile" required>
                        <img id="mainImage" src="{{ asset($products->product_thambnail) }}"
                ...
                <div class="card-body">
                    <table class="table mb-0 table-striped">
                        ...
                        <tbody>
                            ...
                            <form method="post" action="/update/product/multiimage" enctype="multipart/form-data">
                                @csrf
                                ...
                                @foreach ($multiImgs as $key => $img)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img id="showImage{{ $img->id }}" src="{{ asset($img->photo_name) }}" style="width:70; height: 70px; border : 1px solid gainsboro; border-radius : 5px">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="/product/multiimg/delete/{{ $img->id }}" class="btn btn-danger"
                                                id="delete"> Delete </a>
                                        </td>
                                    </tr>
                                @endforeach
