...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="/update/slider" enctype="multipart/form-data" >
			@csrf
		 ...
		 <input type="hidden" name="old_img" value="{{ $sliders->slider_image }}">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ asset($sliders->slider_image) }}" alt="Admin" style="width:150px; height: 150px; border-radius : 10px; border : 2px solid gainsboro"  >
				</div>
			</div>
